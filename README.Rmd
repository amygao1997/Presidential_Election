...
3. Connect to the database you created with `\c Presidential_Election`.

For example, 
`\c [database name]`

4. Then import your SQL script using:
`\i import_candidate_master.sql`

5. If the terminal does not say `CREATE TABLE`, interpret the error and try again. 
