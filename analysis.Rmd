...
Set the [`output.var` chunk option](https://bookdown.org/yihui/rmarkdown/language-engines.html#sql) to the name of the data frame you want that chunk to return. (See the Markdown source file.)
